  ...
  const list = (anchor) => (
    ...
    >
      <div className={classes.branding}>
        <Typography variant="h5" sx={{ marginTop: 2, marginBottom: 2 }} align="center">Medical consultation Forum </Typography>
      </div>
      <Box sx={{ marginTop: 2, marginBottom: 2 }} >
        <Avatar

          alt={fullname(loggedInUser?.name).toUpperCase()}
          src={`https://elonkiptoo.s3.us-east-2.amazonaws.com/${loggedInUser?.photo}`}
          sx={{
            width: 100,
            height: 100,
            bgcolor: blue[500],
