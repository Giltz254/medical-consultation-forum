...
function Copyright() {
    return (<Typography variant="body2" color="textSecondary" align="center"> {"Copyright © "}
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (! error.count) {
            try {
                ...
                if (resp ?. data) { // if user is student, faculty or non-faculty -message please use the app version
                    const {user} = resp ?. data ?. data;
                    if (notAllowedUsers.includes(user.role)) { // clear jwt from headers
    ...
    const handleForgotPassword = async () => {
        ...
        try { // throw error for empty email field
            if (!user.email) {
                ...
                <Grid item
                    ...
                    <Grid className={
                        ...
                        <Typography variant="h6" align='center'
                            ...
                            Welcome to MUST Medical Consultation Forum
                        </Typography>
                        <Box // elevation={4}
                            // component={Paper}
                            sx={
                            ...
                            <img alt="consultation" src="/assets/img/mock-up.png"
                                className={
